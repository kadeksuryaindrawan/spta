        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    <div class="col-10">
                        <h4 class="card-title">Edit TA</h4>
                    </div>
                    </div>
                    ...
                    <?php if($this->session->flashdata('error')): ?>
							...
							<?php endif ?>
                        <form action="<?= base_url('TAController/editProcess/').$ta['ta_id'] ?>" method="POST"  enctype="multipart/form-data">
                            <input type="hidden" value="<?= $ta['ta_id'] ?>" name="ta_id">
                            <div class="form-group">
                                ...
                                <select name="nim" id="mahasiswa" class="form-control input-default">
                                    ...
                                    foreach ($mhs->result_array() as $key): 
                                        $selected = ($key['nim'] == $ta['nim']) ? 'selected' : '';
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control input-default" id="judul" value="<?= $ta['judul'] ?>">
                            </div>
