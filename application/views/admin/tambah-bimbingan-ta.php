        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    <div class="col-10">
                        <h4 class="card-title">Tambah Bimbingan TA</h4>
                    </div>
                    </div>
                    ...
                    <?php if($this->session->flashdata('error')): ?>
							...
							<?php endif ?>
                        <form action="<?= base_url('TAController/addBimbingan') ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <select name="ta_id" id="ta" class="form-control input-default">
                                    ...
                                    foreach ($ta->result_array() as $key): ?>
                                        <option value="<?= $key['ta_id'] ?>"><?= $key['judul'] ?></option>
		                            <?php endforeach ?>
                                </select>
                            </div>
