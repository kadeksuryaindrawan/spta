        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    <div class="col-10">
                        <h4 class="card-title">Tambah TA</h4>
                    </div>
                    </div>
                    ...
                    <?php if($this->session->flashdata('error')): ?>
							...
							<?php endif ?>
                        <form action="<?= base_url('TAController/add') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control input-default" id="judul">
                            </div>
