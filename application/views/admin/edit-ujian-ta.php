        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    <div class="col-10">
                        <h4 class="card-title">Edit Ujian TA</h4>
                    </div>
                    </div>
                    ...
                    <?php if($this->session->flashdata('error')): ?>
							...
							<?php endif ?>
                        <form action="<?= base_url('UjianController/editUjianTAProcess/').$ujian['ujian_ta_id'] ?>" method="POST"  enctype="multipart/form-data">
                            <input type="hidden" value="<?= $ujian['ujian_ta_id'] ?>" name="ujian_ta_id">
                        ...
                        <div class="row mt-2">
                                <div class="col-12">
                                    <a href="<?= base_url('UjianController/ta') ?>"><button class="w-100 btn btn-danger text-white">Kembali</button></a>
                                </div>
                            </div>
                    </div>
                </div>
